...
void BTree::convertBinToTxt(const string& binFilename, const string& txtFilename) {
    ...
    out << "Ordem (m): " << file_m << "\n\n";
    out << left << setw(6)  << "ID"
        << left << setw(20) << " Endereco do Nó"
        << left << setw(10) << " ID pai"
        << left << setw(20) << " Endereco do Pai"
        << left << setw(6)  << " Eh Folha"
        << left << setw(10) << " Qtd Chaves"
        << left << setw(25) << " Chaves"
        << left << setw(12) << " N° de Filhos"
        << left << setw(25) << " ID Filhos"
        << left << setw(25) << " Endereco do Filho"
        << "\n";
    out << string(150, '-') << "\n";
